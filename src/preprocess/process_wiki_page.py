...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir_path", type=str, default=None, help="Path to the cleaned Wikipedia dir)"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Used for filtering the title",
    )
    ...
    file_paths = [
        file_path for file_path in Path(args.dir_path).rglob("*") if file_path.is_file()
    ]
